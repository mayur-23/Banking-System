      ...
      <?php
        ...
        while($row = mysqli_fetch_assoc($query_run)){
          ...
          <tr>
            ...
            <td>
              <button class="btn" name=""><a href="view_profile.php?bn=<?php echo $row['id'];?>">View Profile</a></button>
              <button class="btn" name=""><a href="delete_user.php?bn=<?php echo $row['id'];?>">Delete Costomer</a></button>
            </td>
          </tr>
          <?php
        }
